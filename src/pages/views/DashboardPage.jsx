...
import {
  ...
  GaugeBrightness,
  GaugeTemperature,
} from '@/components/gauges/wrappers';
 ...
 *
 * @param {Object} props
 * @param {number} props.greenhouseId - ID of the greenhouse to fetch data for.
 * @returns {JSX.Element}
 */
export default function Dashboard({ greenhouseId = 1 }) {
  ...
  if (isError) {
    return <div className="dashboard">Error loading sensor data.</div>;
  }
